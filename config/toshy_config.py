...
keymap("VSCodes", {
    ...
    C("RC-C"):                  C("C-Shift-C"),
    C("RC-V"):                  C("C-Shift-V"),
    C("Super-Shift-R"):             C("C-Shift-R"), # refactor
    C("Super-Shift-Right"):             C("C-Shift-Right"), # smart select
    C("Super-Shift-Left"):             C("C-Shift-Left"), # smart select
    # C("Alt-Shift-Right"):             C("Alt-Shift-Right"), # ?
    # C("Alt-Shift-Left"):             C("Alt-Shift-Left"), # ?
...
keymap("GenGUI overrides: GNOME", {
    ...
    C("RC-Shift-Key_4"):        C("Print"),                     # Take a screenshot interactively (gnome)
